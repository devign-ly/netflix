...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(13), __webpack_require__(17)))
  ...
  for (var g = [], c = null, l = g, r = 0, t = [], v = 0; v < b.length; v++) {
    ...
    if (null !== k) {
      ...
      for (c = k.length - d - 1; 1 <= c; c--) {
        d = [], m = k[c], (n = k[c - 1].functionName) ? (f = n.lastIndexOf("."), -1 === f && (f = 0), "use" === n.substr(f, 3) && (f += 3), n = n.substr(f)) : n = "", n = {
          id: null,
          isStateEditable: !1,
          name: n,
          value: void 0,
...
function O(a, b, d) {
  var c,
      ...
      f = null,
      g = null;
  if (null != b) for (c in void 0 !== b.ref && (g = b.ref), void 0 !== b.key && (f = "" + b.key), b) {
  ...
  if (a && a.defaultProps) for (c in h = a.defaultProps, h) {
    void 0 === e[c] && (e[c] = h[c]);
  }
  return {
    $$typeof: l,
...
function renderer_attach(hook, rendererID, renderer, global) {
  ...
  function copyElementPath(id, path) {
    ...
    if (inspectedElement !== null) {
      Object(utils["b" /* copyToClipboard */])(Object(src_utils["j" /* getInObject */])(inspectedElement, path));
    }
  }
